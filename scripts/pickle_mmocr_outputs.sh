...
do
    # echo $f
    python ../pickle_mmocr_outputs.py --videos $f --output /nfs/data/fakenarratives/BildTV/results/20230202_mmocr --fps $FPS
done
...
do
    # echo $f
    python ../pickle_mmocr_outputs.py --videos $f --output /nfs/data/fakenarratives/CompactTV/results/20230202_mmocr --fps $FPS
done
...
do
    # echo $f
    python ../pickle_mmocr_outputs.py --videos $f --output /nfs/data/fakenarratives/tagesschau/results/20230202_mmocr --fps $FPS
done
