...
do
    # echo $f
    python pickle_VisE_outputs.py --cfg VisE/resources/VisE-D/models/VisE_CO_cos.yml --videos $f --output /nfs/data/fakenarratives/BildTV/results/20230202_VisE --fps $FPS
done
...
do
    # echo $f
    python pickle_VisE_outputs.py --cfg VisE/resources/VisE-D/models/VisE_CO_cos.yml --videos $f --output /nfs/data/fakenarratives/CompactTV/results/20230202_VisE --fps $FPS
done
...
do
    # echo $f
    python pickle_VisE_outputs.py --cfg VisE/resources/VisE-D/models/VisE_CO_cos.yml --videos $f --output /nfs/data/fakenarratives/tagesschau/results/20230202_VisE --fps $FPS
done
