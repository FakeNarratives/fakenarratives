...
def main():
    ...
    with open("text_analysis/wikidata_ids/organization.json", "r") as f:
        org_list = json.load(f)

    with open("text_analysis/wikidata_ids/occurrence_event.json", "r") as f:
    ...
    for i, input_path in enumerate(input_paths):
        ...
        if os.path.exists(os.path.join(out_loc, "whisperx_ner.pkl")) and not args.rewrite:
        ...
        ner_feat_dict2 = perform_ner(input_path, speaker_turns, nlp, ner_dict, org_list, event_list)
